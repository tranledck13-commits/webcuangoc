...
<head>
    ...
    <style type="text/css">
        ...
        .has-copyable .copy.show {
            display: block;
        }

        .has-copyable .form-control {
            padding-right: 30px;
        }
    </style>
</head>
            ...
            <div class="modal-body">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="form-row mt-2">
                        ...
                        <div class="form-group col-md-6 mb-2">
                            <label class="control-label pr-1" for="customLink_sub_id4">Sub_id4 (Do not change)</label>
                            <input type="text" name="customLink_sub_id4" id="customLink_sub_id4" class="form-control" value="" readonly>
                        </div>
                        <div class="form-group col-12 mb-2">
                            <label class="control-label pr-1" for="customLink_sub_id5">Sub_id5 (Do not change)</label>
    ...
    <script type="text/javascript">
        ...
        function isValidShopeeUrl(url) {
            try {
                ...
                return parsed.hostname.indexOf('shopee.') !== -1;
            } catch (e) {
                return false;
            }
        }
